//Ejercicio 5 Práctica 3 - Alberto Ortiz

 /* Ejercicio 4.1:
 *   Time-slicing HABILITADO (configUSE_TIME_SLICING = 1 en FreeRTOSConfig.h)
 *   TASK5 tiene prioridad 2 (mayor que el resto, que tienen prioridad 1)
 *   ITERATE_i = 200000, TASK_i_T = 200 ms*/
...
//TASK 5  (prioridad 2 — MAYOR que las demás)
...
void app_main(void)
{
    ...
    //TASK1..4 prioridad 1, TASK5 prioridad 2
    ...
    xTaskCreate(vTaskCode5, "TASK5", STACK_SIZE, NULL, 2, &xHandle5); /* Pri 2 */
